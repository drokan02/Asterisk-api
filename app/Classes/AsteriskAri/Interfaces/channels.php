...
namespace App\Classes\AsteriskAri\Interfaces;

use App\Classes\AsteriskAri\Helpers\parsing_helper;
use Exception;
    ...
    class channels //extends phpari
    {
         ...
         * @return array|bool
         */
        public function     Uchannel_create(string $endpoint, string $app, array $options = [])
        {
            $response = false;
            $defaults = [
                'endpoint' => $endpoint,
            ...
            try {
                ...
                $uri = '/channels/create';
                $aux =$this->pestObject->post($uri, $originateData);
                return $aux;
